        ...
        <div class="row row-cad-cliente">
            ...
            <div class="dados-usuario col-sm-5">
                <form method="POST" action="" id="form-finalizar-compra">
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <select class="form-control input-sm" name="cliente[orgao_expedidor]" id="orgao_expedidor" >
                            ...
                            <?php foreach ($orgaosExpedidores as $orgaosExpedidor): ?>
                                <option <?php echo ($orgaosExpedidor['idorgao_expedidores']==$nome['orgao_expedidor'] ? 'selected="selected"':'') ?>value="<?php echo $orgaosExpedidor['idorgao_expedidores']; ?>"><?php echo $orgaosExpedidor['orgao_expedidor']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="form-inline form-inline-sm div-tel-telefone">
                        ...
                        <input type="text" name="cliente[ddd]" id="ddd" class="form-control input-sm"/>
                        <input type="text" name="cliente[telefone]" id="telefone" class="form-control input-sm" maxlength="9"/>
                    </div><br/>
                    <div class="form-inline form-inline-sm div-tel-celular">
                        ...
                        <input type="text" name="cliente[ddd-cel]" id="ddd-cel" class="form-control input-sm"/>
                        <input type="text" name="cliente[celular]" id="celular" class="form-control input-sm" maxlength="10"/>
                    </div>
            ...
            <div class="dados-usuario-endereco col-sm-5">
                <div class="form-group form-group-sm">
                    ...
                    <select class="form-control input-sm" name="cliente[logradouro]" id="logradouro">
                        ...
                        <?php foreach ($tipoLogradouros as $tipoLogradouro): ?>
                            <option <?php echo ($tipoLogradouro['idtp_logradouros']==$nome['logradouro'] ? 'selected="selected"':'') ?>value="<?php echo $tipoLogradouro['idtp_logradouros']; ?>"><?php echo $tipoLogradouro['tp_logradouro']; ?></option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group form-group-sm">
                    ...
                    <input type="text" name="cliente[cep]" id="cep" class="form-control input-sm"/>
                </div>
                <div class="form-group form-group-sm">
                    <label class="control-label tam-label" for="bairro">Bairro:</label>
                    <input type="text" name="cliente[bairro]" id="bairro" class="form-control input-sm"/>
                </div>
                
                <div class="form-group form-group-sm">
                    <label class="control-label tam-label" for="cidade">Cidade:</label>
                    <input type="text" name="cliente[cidade]" id="cidade" class="form-control input-sm"/>
                </div>
                <div class="form-group form-group-sm">
