    ...
    <aside class="row-fluid container container-produto_categoria_mostra col-md-12 col-lg-12 col-sm-10 col-xs-12">
        <div class="row row-produto_categoria_mostra">
            <div class="thumbnail produto-thumbnail">
                <figure class="produto_foto">
                    <img src="/assets/images/produtos/<?php echo $produtos['imagem']; ?>" border="0" width="280" height="200" id="img_prod"/>
